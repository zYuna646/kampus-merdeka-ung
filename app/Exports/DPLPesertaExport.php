...
class DPLPesertaExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithEvents
{
    protected $data;
    ...
    public function collection()
    {
        return collect($this->data)->map(function ($item, $index) {
            ...
            $dpl = DPL::where('dosen_id', $item['dosen_id'])->where('lowongan_id', $item['lowongan_id'])->first();
            ...
            return [
                ...
                'Program Studi' => $dpl->dosen->studi->name ?? '',
