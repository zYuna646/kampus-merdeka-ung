...
<section class="h-screen flex flex-col relative">
  <div class="w-full h-full bg-color-primary-500 flex-[3] flex justify-end ">
    <div class="xl:inline-flex items-center justify-center px-6 gap-x-2 hidden max-w-screen-xl mx-auto">
  ...
  <div class="w-full h-screen absolute">
    <div class="max-w-screen-xl w-full h-full mx-auto flex items-center justify-center xl:justify-end px-4">
      <div class="xl:p-12 p-8 bg-white rounded-3xl max-w-lg w-full flex flex-col gap-y-4 shadow-md">
        ...
        <form class="xl:mt-4" action="/login" method="POST">
          ...
          <div class="mb-5">
            ...
            <input type="text" name="username" id="username"
              class="block w-full xl:p-4 p-3 text-gray-900 border border-gray-300 rounded-md bg-gray-50 xl:text-base text-xs " value="{{old('username')}}">
              @error('username')
          ...
          <div class="mb-2">
            ...
            <input type="password" name="password" id="password"
              class="block w-full xl:p-4 p-3 text-gray-900 border border-gray-300 rounded-md bg-gray-50 xl:text-base text-xs " value="{{old('password')}}">
              @error('password')
                    <div class="invalid-feedback text-red-400">
                        {{$message}}
                    </div>
