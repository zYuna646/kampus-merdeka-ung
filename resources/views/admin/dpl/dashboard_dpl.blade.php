                ...
                <div class="grid grid-cols-12 p-10 bg-white rounded-xl border border-slate-200 shadow-sm">
                        ...
                        <div class="flex flex-col">
                            ...
                            @php
                                $tanggalMulai = \Carbon\Carbon::parse(
                                    $data['program']->lowongan->tanggal_mulai,
                                );
                                $tanggalSelesai = \Carbon\Carbon::parse(
                                    $data['program']->lowongan->tanggal_selesai,
                                );
                    ...
                    <div class="col-span-12 mt-4 flex gap-x-1">
                        <a href="{{ route('dosen.program.detail', ['lowongan_id' => $data['program']->lowongan->id]) }}"
                            class="text-white h-full bg-color-primary-500 hover:bg-color-primary-600 focus:ring-4 focus:ring-color-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 inline-block">
                             Detail Program
                         </a>
