    ...
    <div class="col-span-12 lg:col-span-8 w-full flex flex-col gap-y-2">
        ...
        <div class="p-8 bg-white w-full rounded-xl broder border-gray-200 shadow flex flex-col gap-y-4">
            ...
            <div class="flex flex-col gap-y-2">
                <form action="{{ route('student.rancangan.submit', ['id' => $data['programTransaction']->id]) }}"
                    method="POST">
                    @csrf
            ...
            <div class="flex flex-col gap-y-2">
                <form action="" class="flex items-center w-full gap-x-2">
                    ...
                    <a href="{{ $data['programTransaction']->rancangan }}" target="_blank" rel="noopener noreferrer"
        ...
        <div class="p-8 bg-white w-full rounded-xl broder border-gray-200 shadow ">
            <div class="flex justify-between flex-col lg:flex-row gap-y-4">
                <div class="flex flex-col gap-y-1">
                    <div class="flex gap-x-2 items-center">
                        @switch($item->status)
                        @case('terima')
                        <span class="text-color-success-500"><i class="fas fa-marker text-sm"></i></span>
                        <span class="text-color-success-500">Diterima</span>
                        @break

                        @case('proses')
                        <span class="text-color-warning-500"><i class="fas fa-marker text-sm"></i></span>
                        <span class="text-color-warning-500">Sedang Diproses</span>
                        @break

                        @case('tolak')
                        <span class="text-color-danger-500"><i class="fas fa-marker text-sm"></i></span>
                        <span class="text-color-danger-500">Ditolak</span>
                        @break

                        @default
                        <span class="text-gray-500"><i class="fas fa-marker text-sm"></i></span>
            ...
            <div class="flex flex-col justify-center items-start">
                ...
                @if ($allTerima && $item->status == 'terima')
                {{-- <div>
                ...
                @elseif ($allTerima && $item->status == 'proses')
                {{-- <div>
                    <table id="weekly" class="w-full text-xs">
                        <thead>
                            <tr>
                ...
                <div
                    class="p-4 rounded-lg text-sm bg-color-warning-100 border flex items-start border-color-warning-500 w-full">
                    <div class="">
                        <span
                            class=" inline-flex items-center justify-center w-6 h-6 me-2 text-sm font-semibold text-white bg-color-warning-500 rounded-full ">
                            <i class="fas fa-exclamation"></i>
                    ...
                    <p class="font-semibold ">Laporan mungguan anda sedang di tinjau oleh DPL dan pamong, silahkan
                        menunggu</p>
                </div>
                @elseif ($allTerima && $item->status == 'belum')
                ...
                <a href="{{ route('student.daily_logbook', ['id' => $item->id]) }}"
                    class="text-white h-full bg-color-primary-500 hover:bg-color-primary-600 focus:ring-4 focus:ring-color-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mt-2">
