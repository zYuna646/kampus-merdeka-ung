            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                      ...
                      <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-color-primary-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Log Book</a>
                    </div>
                  </li>
            </ol>
        </div>
                ...
                @foreach ($data['programTransaction']->weeklyLog as $index => $item)
                    <div class="p-8 bg-white w-full rounded-xl broder border-gray-200 shadow ">
                        ...
                        <div class="flex flex-col justify-center items-start">
                            ...
                            <form id="weeklyForm" method="POST" action="{{ route('student.weekly_logbookForm.edit', ['id' => $item->id]) }}">
                                @csrf
