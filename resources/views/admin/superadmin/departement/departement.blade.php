...
<section class="max-w-screen-xl mx-auto min-h-screen flex flex-col py-44 px-4 lg:px-12 gap-4">
    ...
    <div class="flex justify-between lg:flex-row flex-col gap-y-4  lg:items-center">
        ...
        <div class="inline-flex gap-2 flex-wrap">
            ...
            <x-button_md type="button" class="" onclick="window.location.href='{{ route('admin.departement.add') }}'">
            ...
            <div id="importModal" class="fixed z-10 inset-0 overflow-y-auto hidden">
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div
                        ...
                        <form action="{{ route('admin.departement.import') }}" method="POST"
                            ...
                            <div class="p-4 px-6 inline-flex justify-between w-full">
                                <div class="inline-flex items-center gap-x-2">
                                    ...
                                    <x-button_sm class="inline-flex items-center gap-x-2" color="info">
                                        <a href="{{ asset('templates/jurusan_template.xlsx') }}" download>
                            ...
                            <div class="max-w-lg w-full px-4">
                                <div class=" w-full p-6 bg-white rounded-xl">
                                    ...
                                    <div class="w-full inline-flex mt-4 gap-x-1">
                                        <x-button_sm class="inline-flex items-center gap-x-2" color="info"
                                            onclick="window.location.href='{{ route('admin.departement.edit', $item->id) }}'">
    ...
    function modalOpen(button) {
        ...
        modalContent.innerHTML = `
            <div class="flex flex-col gap-y-px">
                <p class="font-semibold ">Kode Jurusan</p>
                <p class="">${code}</p>
            </div>
            <div class="flex flex-col gap-y-px">
                <p class="font-semibold ">Nama Jurusan</p>
                <p class="">${name}</p>
            </div> 
            <div class="flex flex-col gap-y-px">
