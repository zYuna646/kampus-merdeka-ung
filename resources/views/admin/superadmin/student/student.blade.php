...
<section class="max-w-screen-xl mx-auto min-h-screen flex flex-col py-44 px-4 lg:px-12 gap-4">
    ...
    <div class="flex justify-between lg:flex-row flex-col lg:items-center gap-y-4">
        ...
        <div class="inline-flex flex-wrap gap-2">
            <!-- Tombol Import -->
            <x-button_md type="button" onclick="window.location.href='{{ route('admin.student.add') }}'">
                            ...
                            <div class="p-4 px-6 inline-flex justify-between w-full">
                                <div class="inline-flex items-center gap-x-2">
                                    ...
                                    <x-button_sm class="inline-flex items-center gap-x-2" color="info"
                                        onclick="window.location.href='{{ asset('templates/mahasiswa_template.xlsx') }}'">
            ...
            <x-button_md type="button" color="warning"
                onclick="window.location.href='{{ route('admin.student.export') }}'">
            ...
            <form action="{{ route('admin.student') }}" method="GET">
                <div class="w-full grid grid-cols-12 gap-4">
                    <div class="col-span-6">
                        <label for="jurusan" class="block mb-2 text-xs xl:text-sm text-gray-900 dark:text-white">Program
                            Studi :</label>
                    ...
                    <div class="col-span-6">
                        <label for="angkatan"
                            class="block mb-2 text-xs xl:text-sm text-gray-900 dark:text-white">Angkatan :</label>
                        <select name="angkatan" id="angkatan"
                            class="block w-full p-2 text-gray-900 border border-gray-300 rounded-md bg-gray-50 text-xs"
                            onchange="this.form.submit()">
                            <option value="">Semua Angkatan</option>
                            @foreach ($angkatans as $angkatan)
                            <option value="{{ $angkatan->angkatan }}" {{ $selectedAngkatan==$angkatan->angkatan ?
                                'selected' : '' }}>
                                {{ $angkatan->angkatan }}
                            </option>
                            @endforeach
                            ...
                            <div class="relative inline-block text-left">
                                ...
                                <div id="dropdownMenu{{ $item->id }}"
                                    ...
                                    <div class="py-1" role="none">
                                        <button data-id="{{ $item->id }}" data-nim="{{ $item->nim }}"
