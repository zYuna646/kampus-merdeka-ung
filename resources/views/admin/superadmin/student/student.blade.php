    ...
    <section class="max-w-screen-xl mx-auto min-h-screen flex flex-col py-44 px-4 lg:px-12 gap-4">
        <div class="flex justify-between lg:flex-row flex-col lg:items-center gap-y-4">
            ...
            <div class="inline-flex">
                <!-- Tombol Import -->
                <x-button_md type="button"  class="me-2" onclick="window.location.href='{{ route('admin.student.add') }}'">
                ...
                <!-- Tombol Export -->
                <x-button_md type="button" color="warning" class="ms-2" onclick="window.location.href='{{ route('admin.student.export') }}'">
