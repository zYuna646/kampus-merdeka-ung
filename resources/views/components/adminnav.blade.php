    ...
    const menus = {
        "admin": [
            ...
            },
            {
                ...
                "submenu": [
                    {
                        "label": "Program Kampus Merdeka",
                        "route": "{{ route('admin.campus_merdeka_program') }}"
                    },
                    {
                        "label": "Fakultas",
            ...
            },
            {
                ...
                "submenu": [
                    {
                        "label": "Dosen",
                        "route": "{{ route('admin.dosen') }}"
                    },
                    {
                        "label": "Mahasiswa",
                        "route": "{{ route('admin.mahasis') }}"
                    },
                ]
            },
        ...
        "mahasiswa": [
            ...
            },
            {
                ...
                "submenu": [
                    {
                        "label": "Log Book",
                        "route": "{{ route('student.weekly_logbook') }}"
                    },
                    // tambahkan submenu lainnya di sini
                ]
            },
            // tambahkan menu lainnya untuk mahasiswa di sini
        ]
    };
</script>